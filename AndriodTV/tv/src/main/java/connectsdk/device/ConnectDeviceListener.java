...
public interface ConnectDeviceListener {
     ...
     */
    public void onDeviceReady(ConnectDevice device);
     ...
     */
    public void onDeviceDisconnected(ConnectDevice device);
     ...
     */
    public void onPairingRequired(ConnectDevice device, DeviceService service, PairingType pairingType);
