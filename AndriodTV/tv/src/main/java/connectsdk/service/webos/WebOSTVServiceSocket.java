        ...
        package connectsdk.service.webos;
        ...
        import connectsdk.service.WebOSTVService;
        import connectsdk.service.capability.listeners.ResponseListener;
        import connectsdk.service.command.ServiceCommand;
        import connectsdk.service.command.ServiceCommand.ServiceCommandProcessor;
        ...
        import connectsdk.service.config.WEBOSTV;
...
//                Log.d(Util.T, "Found requests need to handle response");
                ...
                if (!(request instanceof URLServiceSub)) {
            ...
            if (!(mService.getServiceConfig() instanceof WEBOSTV)) {
                mService.setServiceConfig(new WEBOSTV(mService.getServiceConfig().getServiceUUID()));
            }

            if (payload instanceof JSONObject) {
                String clientKey = ((JSONObject) payload).optString("client-key");
                ((WEBOSTV) mService.getServiceConfig()).setClientKey(clientKey);
                ...
                if (verification_status) {
                    ((WEBOSTV) mService.getServiceConfig()).setServerCertificate(customTrustManager.getLastCheckedCertificate());
                    handleRegistered();
            ...
            if (mService.getServiceConfig().getServiceUUID() != null) {
                if (!mService.getServiceConfig().getServiceUUID().equals(jsonObj.optString("deviceUUID"))) {
                    ((WEBOSTV)mService.getServiceConfig()).setClientKey(null);
                    ((WEBOSTV)mService.getServiceConfig()).setServerCertificate((String)null);
    ...
    protected void sendRegister() {
        ...
        try {
            ...
            if (((WEBOSTV)mService.getServiceConfig()).getClientKey() != null) {
                payload.put("client-key", ((WEBOSTV)mService.getServiceConfig()).getClientKey());
            }
...
//        connectableDeviceStore.addDevice(storedDevice);
    ...
    public void unsubscribe(ServiceSubscriptions<?> subscription) { }
    ...
    protected void setupSSL() {
        try {
            ...
            customTrustManager.setExpectedCertificate(((WEBOSTV)mService.getServiceConfig()).getServerCertificate());
...
//            }
    ...
    public void setServerCertificate(X509Certificate cert) {
        ...
        ((WEBOSTV)mService.getServiceConfig()).setServerCertificate(cert);
    }
    ...
    public void setServerCertificate(String cert) {
        ...
        ((WEBOSTV)mService.getServiceConfig()).setServerCertificate(loadCertificateFromPEM(cert));
    }
    ...
    public X509Certificate getServerCertificate() {
        ...
        return ((WEBOSTV)mService.getServiceConfig()).getServerCertificate();
    }
    ...
    public String getServerCertificateInString() {
        ...
        return exportCertificateToPEM(((WEBOSTV)mService.getServiceConfig()).getServerCertificate());
    }
