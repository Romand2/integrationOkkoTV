...
public class WebOSWebAppSession extends WebAppSession {
    ...
    public URLServiceSub<ResponseListener<Object>> appToAppSubscription;

    private ServiceSubscriptions<PlayStateListener> mPlayStateSubscription;
    private ServiceSubscriptions<MessageListener> mMessageSubscription;
    private ConcurrentHashMap<String, ServiceCommand<?>> mActiveCommands;

    private ServiceSubscriptions<WebAppPinStatusListener> mWebAppPinnedSubscription;
