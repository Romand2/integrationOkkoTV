...
import android.util.Log;
        ...
        import connectsdk.service.roku.RokuAppListParser;
...
public class RokuService extends DeviceService implements Launcher, MediaPlayer, MediaControl, KeyControl, TextInputControl {
    ...
    public RokuService(ServiceDisc serviceDescription,
        ...
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            public void onSuccess(Object response) {
                ...
                try {
                    ...
                    RokuAppListParser parser = new RokuAppListParser();
    ...
    @Override
    public ServiceSubscriptions<AppInfoListener> subscribeRunningApp(
    ...
    @Override
    public ServiceSubscriptions<TextInputStatusListener> subscribeTextInputStatus(
    ...
    public DialService getDIALService() {
        if (dialService == null) {
            ...
            ConnectDevice device = discoveryManager.getAllDevices().get(
