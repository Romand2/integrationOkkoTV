...
package connectsdk.service;
        ...
        import connectsdk.helper.DeviceServiceRichability.DeviceServiceReachabilityListener;
...
public class DeviceService implements DeviceServiceReachabilityListener, ServiceCommandProcessor {
    ...
    ServiceDisc serviceDescription;

    ServiceConfig serviceConfig;

    protected DeviceServiceRichability mServiceReachability;
    ...
    public DeviceService(ServiceDisc serviceDescription, ServiceConfig serviceConfig) {
    ...
    public static DeviceService getService(JSONObject json) {
        ...
        try {
            ...
            Constructor<DeviceService> constructor = newServiceClass.getConstructor(ServiceDisc.class, ServiceConfig.class);
            ...
            ServiceDisc serviceDescription = null;
            if (jsonDescription != null)
                serviceDescription = ServiceDisc.getDescription(jsonDescription);
    ...
    public static DeviceService getService(Class<? extends DeviceService> clazz, ServiceDisc serviceDescription, ServiceConfig serviceConfig) {
        try {
            Constructor<? extends DeviceService> constructor = clazz.getConstructor(ServiceDisc.class, ServiceConfig.class);
    ...
    protected void reportConnected(boolean ready) {
        ...
        if (listener instanceof ConnectDevice)
    ...
    //  Unused by default.
    @Override public void onLoseReachability(DeviceServiceRichability reachability) { }
    // @endcond
