...
public class WEBOSTV extends ServiceConfig {
    ...
    public WEBOSTV(String serviceUUID) {
        super(serviceUUID);
    }

    public WEBOSTV(String serviceUUID, String clientKey) {
        super(serviceUUID);
        this.clientKey = clientKey;
        this.cert = null;
    }

    public WEBOSTV(String serviceUUID, String clientKey, X509Certificate cert) {
        super(serviceUUID);
        this.clientKey = clientKey;
        this.cert = cert;
    }

    public WEBOSTV(String serviceUUID, String clientKey, String cert) {
        super(serviceUUID);
        this.clientKey = clientKey;
        this.cert = loadCertificateFromPEM(cert);
    }

    public WEBOSTV(JSONObject json) {
        super(json);
