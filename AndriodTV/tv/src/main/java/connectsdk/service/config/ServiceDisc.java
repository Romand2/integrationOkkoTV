...
public class ServiceDisc implements Cloneable {
    ...
    public ServiceDisc(String serviceFilter, String UUID, String ipAddress) {
        this.serviceFilter = serviceFilter;
        this.UUID = UUID;
        this.ipAddress = ipAddress;
    }

    public ServiceDisc(JSONObject json) {
    ...
    public static ServiceDisc getDescription(JSONObject json) {
        return new ServiceDisc(json);
    }
    ...
    public ServiceDisc clone() {
        ServiceDisc service = new ServiceDisc();
