package connectsdk.service.upnp;

import connectsdk.core.MediaInfo;
import connectsdk.core.Util;
import connectsdk.service.capability.MediaControl.PlayStateStatus;
...
public class DLNAHttpServer {
    ...
    CopyOnWriteArrayList<URLServiceSub<?>> subscriptions;

    public DLNAHttpServer() {
        subscriptions = new CopyOnWriteArrayList<URLServiceSub<?>>();
    }
    ...
    public synchronized void stop() {
        ...
        for (URLServiceSub<?> sub : subscriptions) {
            sub.unsubscribe();
        }
        subscriptions.clear();
    ...
    public List<URLServiceSub<?>> getSubscriptions() {
        return subscriptions;
    }

    public void setSubscriptions(List<URLServiceSub<?>> subscriptions) {
        this.subscriptions = new CopyOnWriteArrayList<URLServiceSub<?>>(subscriptions);
    }
