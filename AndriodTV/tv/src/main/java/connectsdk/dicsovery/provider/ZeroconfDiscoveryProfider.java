...
public class ZeroconfDiscoveryProfider implements DiscoveryProvider {
    ...
    ConcurrentHashMap<String, ServiceDisc> foundServices;
    ...
    ServiceListener jmdnsListener = new ServiceListener() {
        ...
        public void serviceResolved(ServiceEvent ev) {
            ...
            ServiceDisc foundService = foundServices.get(ipAddress);
            ...
            if (listUpdateFlag) {
                for (DiscoveryProviderListener listener: serviceListeners) {
                    listener.onServiceAdded(ZeroconfDiscoveryProfider.this, foundService);
                }
            }
        }
        ...
        public void serviceRemoved(ServiceEvent ev) {
            ...
            if (service != null) {
                Util.runOnUI(new Runnable() {
                    ...
                    public void run() {
                        for (DiscoveryProviderListener listener : serviceListeners) {
                            listener.onServiceRemoved(ZeroconfDiscoveryProfider.this, service);
                        }
                    }
                });
            }
    ...
    public ZeroconfDiscoveryProfider(Context context) {
        foundServices = new ConcurrentHashMap<String, ServiceDisc>(8, 0.75f, 2);
